...
public class PreferencesManager {
    ...
    public static final String CREATE_TABLE_PREFERENCES = "CREATE TABLE "+TABLE_NAME+
            ...
            " "+KEY_PREF_LANGUAGE_FR+" INTEGER not null default 1," +
            " "+KEY_PREF_LANGUAGE_EN+" INTEGER not null default 1," +
            " "+KEY_PREF_HAIR_COLOR_BLOND+" INTEGER not null default 1," +
            " "+KEY_PREF_HAIR_COLOR_BLACK+" INTEGER not null default 1," +
            " "+KEY_PREF_HAIR_COLOR_BROWN+" INTEGER not null default 1," +
            " "+KEY_PREF_HAIR_COLOR_GINGER+" INTEGER not null default 1," +
            " "+KEY_PREF_HAIR_COLOR_GREYWHITE+" INTEGER not null default 1," +
            " "+KEY_PREF_HAIR_COLOR_OTHER+" INTEGER not null default 1," +
            " "+KEY_PREF_HAIR_TYPE_SHORT+" INTEGER not null default 1," +
            " "+KEY_PREF_HAIR_TYPE_MEDIUM+" INTEGER not null default 1," +
            " "+KEY_PREF_HAIR_TYPE_LONG+" INTEGER not null default 1," +
            " "+KEY_PREF_EYES_COLOR_BLUE+" INTEGER not null default 1," +
            " "+KEY_PREF_EYES_COLOR_BROWN+" INTEGER not null default 1," +
            " "+KEY_PREF_EYES_COLOR_BLACK+" INTEGER not null default 1," +
            " "+KEY_PREF_EYES_COLOR_GREEN+" INTEGER not null default 1," +
            " "+KEY_PREF_EYES_COLOR_GREY+" INTEGER not null default 1," +
            " "+KEY_PREF_AGE_MAX+" INTEGER not null default 1," +
    ...
    public Preferences getPreferences(long pref_user_id) {
        ...
        Cursor c = db.rawQuery("SELECT * FROM "+TABLE_NAME+" WHERE "+KEY_PREF_USER_ID+"="+pref_user_id, null);
        if (c.moveToFirst()) {
